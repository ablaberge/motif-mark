...
`-m` : Text file with one motif per line and ≤10 bases per motif. Nucleotides must comply with [IUPAC naming conventions](https://genome.ucsc.edu/goldenPath/help/iupac.html). Motif sequences must be free from gaps.
